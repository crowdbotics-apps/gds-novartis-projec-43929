...
## Project Structure
    ...
    ├── gds_novartis_projec_43929  # Django project configurations
...
1. Clone this repo and `cd gds_novartis_projec_43929`
...
2. Clone this repo and `cd gds_novartis_projec_43929`
